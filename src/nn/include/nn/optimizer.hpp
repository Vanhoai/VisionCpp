...
public:
    explicit SGD(const double learningRate, const double momentum = 0.9, const bool nesterov = true,
...
public:
    explicit Adam(const double learningRate, const double epsilon = 1e-15, const double beta1 = 0.9,
