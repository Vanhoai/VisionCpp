...
constexpr int kernelX[3][3] = {
    {-1, 0, 1},
    {-2, 0, 2},
    {-1, 0, 1}
};
constexpr int kernelY[3][3] = {
    {-1, -2, -1},
    {0,  0,  0 },
    {1,  2,  1 }
};
...
public:
     ...
     * @param ksize Size of the kernel (must be odd).
     */
    static void medianBlur(const core::Tensor<core::float32>& src, core::Tensor<core::float32>& dst,
                           int ksize = 5);
     ...
     */
    static void sobel(const core::Tensor<core::float32>& src, core::Tensor<core::float32>& gradX,
     ...
     */
    static void canny(const core::Tensor<core::float32>& src, core::Tensor<core::float32>& dst,
